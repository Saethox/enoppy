...
class HeatExchangerNetworkDesignCase2Problem(Engineer):
    ...
    def __init__(self, f_penalty=None):
        ...
        self._n_eq_cons = 9
        self._n_cons = 9
        self._bounds = np.array([(10**4, 81.9*10**4), (10**4, 113.1*10**4), (10**4, 205*10**4), (1e-9, 5.074*10**(-2)), (1e-9, 5.074*10**(-2)),
                        (1e-9, 5.074*10**(-2)), (100, 200.), (100., 300.), (100., 300), (100., 300), (100, 400.)])
        self.check_penalty_func(f_penalty)
